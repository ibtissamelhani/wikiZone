    ...
    <nav class="bg-white fixed bg-opacity-25 dark:bg-gray-900  w-full z-20 top-0 start-0  dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2 space-x-3 items-center gap-8 md:space-x-0 rtl:space-x-reverse">
                ...
                <a href="signin" class="text-md  underline decoration-solid font-semibold hover:text-orange-600 ">Sign
                    in</a>
        ...
        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
            ...
            <a href="profile?id=<?=$_SESSION['userId']?>"
                class="text-md underline decoration-solid font-semibold hover:text-orange-600 ">My wikis</a>

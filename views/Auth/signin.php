...
<div class="min-h-screen bg-[#222] flex items-center justify-center px-5 py-5 bg-cover bg-center" style="background-image: url('/wikizone/public/imgs/1.jpg');">
    <div class="rounded-3xl shadow-xl w-full overflow-hidden max-w-screen-xl md:flex">
        <div class="md:flex flex-col items-center justify-center gap-4 md:w-1/2 bg-[#333] bg-opacity-80 py-10 px-10">
            ...
            <a href="home" class="text-orange-700 hover:text-orange-400 hover:transition-transform transform hover:-translate-x-1 flex items-center gap-2">
            ...
            <form method="post" action="login">
                ...
                <div class="mb-5">
                    ...
                    <div class="flex">
                        ...
                        <input name="password" type="password" id="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                    </div>
                </div>

                <div class="mt-4">
                    <button type="submit" class="block w-full max-w-xs mx-auto bg-orange-700 hover:bg-orange-600 focus:bg-gris-200 text-white rounded-lg px-3 py-3 font-semibold">Login</button>
                </div>
            </form>
        </div>
    </div>
